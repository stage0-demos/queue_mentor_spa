...
import type { ResourceInput, ResourceUpdate } from './types'
...
describe('API Client - Resource Endpoints', () => {
  ...
  it('should update a resource', async () => {
    const update: ResourceUpdate = { name: 'updated-name' }
    ...
    const result = await api.updateResource('507f1f77bcf86cd799439011', update)
  ...
  it('should handle 404 errors', async () => {
    ...
    await expect(api.getResource('invalid-id')).rejects.toThrow(ApiError)
  })
  ...
  it('should handle 401 errors', async () => {
    ...
    await expect(api.getResources()).rejects.toThrow('Unauthorized')
  })
