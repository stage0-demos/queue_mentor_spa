...
ARG GITHUB_TOKEN
RUN echo "@stage0-demos:registry=https://npm.pkg.github.com" > .npmrc && \
...
LABEL org.opencontainers.image.source="https://github.com/stage0-demos/queue_mentor_spa"

ENV API_HOST=queue_mentor_api
ENV API_PORT=8290
